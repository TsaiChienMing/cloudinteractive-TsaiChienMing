...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_FILE = "cloudinteractive.db";
    ...
    public int updateRec(String b_id, String b_name, String b_grp, String b_address) {
        ...
        if (recSet.getCount() != 0) {
            ...
            rec.put("id", b_name);
            rec.put("title", b_grp);
            rec.put("thumbnailUrl", b_address);
    ...
    public long insertRec_news(String b_id, String b_title, String b_url) {
        SQLiteDatabase db = getWritableDatabase();
        ContentValues rec = new ContentValues();
        rec.put("id", b_id);
        rec.put("title", b_title);
        rec.put("thumbnailUrl", b_url);
